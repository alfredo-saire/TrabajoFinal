...
def iniciar():
    ...
    imagen.nroFrames = 8
    imagen.actualFrame = 0
    imagen.animationTime = 0.1
    imagen.currentTime = 0
    imagen.anchoFrame = imagen.rect.width / imagen.nroFrames

    clock = pygame.time.Clock()

def obtenerImagen():
    imagen.currentTime += tiempo
    if imagen.currentTime >= imagen.animationTime:
        imagen.currentTime = 0
